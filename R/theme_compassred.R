...
theme_compassred <- function() {
  ...
  ggplot2::theme(
    ...
    ## Legend format
    # This sets the position and alignment of the legend, removes
    # a title and background for it and sets the requirements for any text
    # within the legend. The legend may often need some more manual tweaking
    ...
    # as well as setting the margins and removes lines and ticks. In some cases,
    ...
    # In many cases you will want to change this to remove y gridlines and add x
